...
\begin{titlingpage}
  ...
  \textbf{\thetitle}\\[0.5cm]
  \normalsize
  Corso tenuto dal Professor Roberto Segala\\[0.5cm]
...
\end{titlingpage}
\tableofcontents
\input{tecniche_classiche}
\input{teoria-dei-numeri.tex}
\input{chiave-pubblica.tex}
\input{casualità.tex}
