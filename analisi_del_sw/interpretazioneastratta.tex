...
Diciamo che $f^\sharp$ è corretta per $f$ se $\alpha \, \circ \,
f(c) \leq_\mathcal{A} f^\sharp \, \circ \, \alpha(c)$.
...
Quindi $f \circ \gamma(a) \leq_\mathcal{C} \gamma \circ f^\sharp(a)$.

\begin{tcolorbox}
    Dato $\galois{\alpha}{\gamma} \mathcal{A}, f: c \to c$, allora $f^\sharp : a \to a$ 
    soddisfa la relazione  
    \[\alpha \, \circ \, f(c) \leq_\mathcal{A} f^\sharp \, \circ \, \alpha(c)\]
    se e solo se soddisfa
    \[f \, \circ \, \gamma(a) \leq_\mathcal{C} \gamma \, \circ \, f^\sharp(a)\]
\end{tcolorbox}
In particolare se partiamo dalla condizione che per ogni $x$ appartenente al dominio concreto,
$\alpha \, \circ \, f(x) \leq_\mathcal{A} f^\sharp \, \circ \, \alpha(x) \iff 
\alpha \, \circ \, f \, \circ \, \gamma(x) \leq_\mathcal{A} f^\sharp(x)$.
dove $\alpha \, \circ \, f \, \circ \, \gamma(x)$ è la funzione \textbf{best 
correct approximation}.
\[
  f^\sharp \textit{ è sound } \iff \textit{ approssima } f^\sharp \equiv \alpha \, \circ \, f \, \circ \, \gamma 
