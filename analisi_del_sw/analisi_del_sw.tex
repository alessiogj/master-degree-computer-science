...
\begin{titlingpage}
  ...
  \textbf{\thetitle}\\[0.5cm]
  \normalsize
  Corso tenuto dalla Professoressa Isabella Mastroeni\\[0.5cm]
...
\tableofcontents
\input{introduzione}
\input{modellareprogrammi}
\input{approx}
\input{analisistatica}
\input{interpretazioneastratta}

\input{analisinondistributive}
\end{document}
