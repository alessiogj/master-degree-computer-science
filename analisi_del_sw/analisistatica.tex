...
\begin{itemize}
    ...
    \item $\mathcal{R}(2) \supseteq \llbracket \texttt{input(x)} \rrbracket^\# \varnothing = (x1)$
    \item $\mathcal{L}(3) \supseteq \llbracket y \gets 1 \rrbracket^\# \mathcal{R}(2) = 
    \mathcal{R}(2) \setminus \texttt{def}(y) \cup (y2) \cup (\mathcal{R}(5) \setminus 
    \texttt{def}(x) \cup (x5))$
    \item $\mathcal{R}(4) \supseteq \mathcal{R}(3)$
    \item $\mathcal{R}(5) \supseteq \llbracket y \gets x \cdot y \rrbracket^\# \mathcal{R}(4) =
    \mathcal{R}(4) \setminus \texttt{def}(y) \cup (y4)$
    \item $\mathcal{R}(6) \supseteq \mathcal{R}(3)$
    \item $\mathcal{R}(7) \supseteq \llbracket R \gets y \rrbracket^\# \mathcal{R}(6) =
