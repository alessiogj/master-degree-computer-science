...
Caratterizziamo quindi la funzione di trasferimento $\llbracket \cdot \rrbracket^\sharp\mathcal{A}$. 
...
\subsubsection{Esempio di analisi true liveness}
...
\begin{minipage}{0.5\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[node distance={12mm}, main/.style = {draw, rectangle}] 
            \node[main] (1) {1. $x \gets I$};
            \node[main] (2) [below =of 1] {2. $y \gets 1$};
            \node[main] (3) [below =of 2] {3. $x \geq 1$};
            \node[main] (4) [below right = of 3] {4. $y \gets x \cdot y$};
            \node[main] (5) [below =of 4] {5. $x \gets x - 1$};
            \node[main] (6) [below left=of 3] {6. \texttt{exit}};
            \draw[->] (1) -- (2);
            \draw[->] (2) -- (3);
            \draw[->] (3) -- (4);
            \draw[->] (4) -- (5);
...
Poiché la variabile $y$ non viene mai utilizzata nelle espressioni, vediamo che non sarà 
mai \textit{live}.
...
\begin{minipage}{0.33\textwidth}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \node[above right = 1.2cm] at (s) {$R \gets y + 1$};
            \node[above right = 1.2cm] at (q) {$y \gets T$};
            \node[above right = 1.2cm] at (p) {$T \gets x + 1$};
...
\begin{minipage}{0.33\textwidth}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \node[above right = 1.2cm] at (s) {$R \gets$\textcolor{orange}{$T$}$+ 1$};
            \node[above right = 1.2cm] at (q) {$y \gets T$};
            \node[above right = 1.2cm] at (p) {$T \gets x + 1$};
...
\begin{minipage}{0.33\textwidth}
    \begin{figure}[H]
        \centering 
        \begin{tikzpicture}
            \node[draw, circle, minimum width = 1.3cm] (s) at (0, -2){$3$};
            \node[draw, circle, minimum width = 1.3cm] (p) at (0, 0) {$2$};
            \node[draw, circle, minimum width = 1.3cm] (r) at (0, 2) {$1$};
    
            \node[above right = 1.2cm] at (s) {$R \gets T + 1$};
            \node[above right = 1.2cm] at (p) {$T \gets x + 1$};
...
Notiamo che la variabile $y$ è la copia di $T$ e quindi possiamo sostituire $y$ con $T$.
...
\subsection{Analisi di Copy Propagation e l'approccio algoritmico}
...
\subsection{Analisi di Copy Propagation e l'approccio semantico}
...
\begin{minipage}{0.5\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[node distance={12mm}, main/.style = {draw, rectangle}] 
            \node[main] (1) {0. $\texttt{entry}$};
            \node[main] (2) [below =of 1] {1. $T \gets x+ 1$};
            \node[main] (3) [below =of 2] {2. $y \gets T$};
            \node[main] (4) [below =of 3] {3. $R \gets y + 1$};
            \node[main] (5) [below =of 4] {4. \texttt{exit}};
            \draw[->] (1) -- (2);
            \draw[->] (2) -- (3);
            \draw[->] (3) -- (4);
            \draw[->] (4) -- (5);
...
\begin{itemize}
    \item $\mathcal{C}(1) \subseteq (zz)$
    \item $\mathcal{C}(2) \subseteq \llbracket T \gets x + 1 \rrbracket \mathcal{C}(1) = 
    \mathcal{C}(1) \setminus \texttt{Copy}(T) $
    \item $\mathcal{C}(3) \subseteq \llbracket y \gets T \rrbracket \mathcal{C}(2) =
    \mathcal{C}(2) \setminus \texttt{Copy}(y)  \cup (yT)$
    \item $\mathcal{C}(4) \subseteq \llbracket R \gets y + 1 \rrbracket \mathcal{C}(3) =
    \mathcal{C}(3) \setminus \texttt{Copy}(R)$
\end{itemize}
...
\begin{figure}[H]
        ...
        \begin{tikzpicture}
            \node[draw, circle, minimum width=0.1cm] (s) at (0, 2.5) {};
            \node[draw, circle, minimum width=0.1cm] (p) at (0,0) {};
        
            \node[right = 0.7cm] at (s) {$x \gets e$};
            \node[right = 0.7cm] at (p) {$p$};
    
            \draw[->,decorate,decoration={snake,amplitude=.4mm,segment length=2mm,post length=1mm}]
            (s) to node[auto, swap] {} (p);
            \draw[decorate, decoration={calligraphic brace, amplitude=6pt, mirror, raise=5pt, aspect=0.5}]
            (s) -- (p) node[midway,left = 0.5] {$\textit{no def } x$};
        \end{tikzpicture}
    \end{figure}
...
L'analisi è chiaramente \textit{forward}, in quanto si parte da un punto di programma e
...
\end{equation}
\subsection{Analisi di Reaching Definitions e l'approccio semantico}
...
\subsubsection{Esempio di analisi di Reaching Definitions}
\subsubsection{Approccio algoritmico}
...
\begin{minipage}{0.5\textwidth}
    ...
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[node distance={12mm}, main/.style = {draw, rectangle}] 
            \node[main] (0) {0. \texttt{entry}};
            \node[main] (1) [below =of 0] {1. $\texttt{Input}(x)$};
            \node[main] (2) [below =of 1] {2. $y \gets 1$};
            \node[main] (3) [below =of 2] {3. $x \geq 1$};
            \node[main] (4) [below right = of 3] {4. $y \gets x \cdot y$};
            \node[main] (5) [below =of 4] {5. $x \gets x - 1$};
            \node[main] (6) [below left=of 3] {6. $R \gets y$};
            \node[main] (7) [below =of 6] {7. \texttt{exit}};
            \draw[->] (0) -- (1);
            \draw[->] (1) -- (2);
            \draw[->] (2) -- (3);
            \draw[->] (3) -- (4);
    ...
    Seguendo la formula per il calcolo del punto fisso della Reaching Definitions, 
...
\begin{minipage}{0.5\textwidth}
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[node distance={22mm}, minimum width = 1cm, main/.style = {draw, circle}] 
            ...
            \draw[->] (1) -- node[left] {$\texttt{Input(x)}$} (2) ;
            \draw[->] (2) -- node[left] {$y \gets 1$} (3) ;
            \draw[->] (3) -- node[right] {$\texttt{NonZero}(x > 1)$} (4);
            \draw[->] (3) --  (6) node[above = 1cm] {$\texttt{Zero}(x > 1)$};
            \draw[->] (4) -- node[right] {$y \gets x \cdot y$} (5);
            \draw[->] (5) -- node[left] {$y \gets x -1$} (3);
            \draw[->] (6) -- node[left] {$R \gets y$} (7);
        \end{tikzpicture}
    \end{figure}
\end{minipage}

\begin{itemize}
    \item $\mathcal{R}(1) \supseteq \varnothing$
    \item $\mathcal{R}(2) \supseteq \llbracket \texttt{input(x)} \rrbracket^\sharp \varnothing = (x1)$
    \item $\mathcal{L}(3) \supseteq \llbracket y \gets 1 \rrbracket^\sharp \mathcal{R}(2) = 
    \mathcal{R}(2) \setminus \texttt{def}(y) \cup (y2) \cup (\mathcal{R}(5) \setminus 
    \texttt{def}(x) \cup (x5))$
    \item $\mathcal{R}(4) \supseteq \mathcal{R}(3)$
    \item $\mathcal{R}(5) \supseteq \llbracket y \gets x \cdot y \rrbracket^\sharp \mathcal{R}(4) =
    \mathcal{R}(4) \setminus \texttt{def}(y) \cup (y4)$
    \item $\mathcal{R}(6) \supseteq \mathcal{R}(3)$
    \item $\mathcal{R}(7) \supseteq \llbracket R \gets y \rrbracket^\sharp \mathcal{R}(6) =
    \mathcal{R}(6) \setminus \texttt{def}(R) \cup (R6)$
\end{itemize}
