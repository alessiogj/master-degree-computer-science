        ...
        Dimostrare che $\texttt{Circuit-SAT}$ è \texttt{NP}-completo equivale a dimostrare
            ...
            \begin{itemize}
                ...
                \item Sfruttiamo il lemma \ref{lemma:np-completeness} per dimostrare che $\texttt{Circuit-SAT}$ è
                    ...
                    trasformazione.
            \end{itemize}
        \item $\texttt{Circuit-SAT} \preceq_p \texttt{SAT}$.
...
\begin{tcolorbox}[title =$\mathbb{A} \preceq_T \mathbb{B}$]
...
Se consideriamo un problema $\mathbb{A}$ appartenente a \texttt{NP} come un predicato $A$ sulle istanze di 
