...
%Re: K per il bianco, k per il nero.
%Regina (o Donna): Q per il bianco, q per il nero.
%Torre: R per il bianco, r per il nero.
%Alfiere: B per il bianco, b per il nero.
%Cavallo: N per il bianco, n per il nero.
%Pedone: P per il bianco, p per il nero.
